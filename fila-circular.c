...
int main()
{
    ...
    do{
        ...
        else if(op1==2){//Adiciono em fila circular
            printf("Digite valor a ser adicionado:\n");
            scanf("%d", &x);
        ...
        else if(op1==3){//Adiciono em pilha
            printf("Digite valor a ser adicionado:\n");
            scanf("%d", &x);
        ...
        if(op2==1){//Removo em fila
            remove_inicio(&inicio1);

            system("pause");
            system("cls");
        }
        else if(op2==2){//Removo em fila-circular
            remove_fila_circular(&inicio2, ultimo);

            system("pause");
            system("cls");
        }
        else if(op2==3){//Removo em pilha
        ...
        else if(op3==2){//Lista fila circular
            printf("\n");
            flag=1;
